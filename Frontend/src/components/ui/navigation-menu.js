...
var NavigationMenuPrimitive = require("@radix-ui/react-navigation-menu@1.2.5");
var class_variance_authority_0_7_1_1 = require("class-variance-authority@0.7.1");
var lucide_react_0_487_0_1 = require("lucide-react@0.487.0");
...
var navigationMenuTriggerStyle = (0, class_variance_authority_0_7_1_1.cva)("group inline-flex h-9 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground disabled:pointer-events-none disabled:opacity-50 data-[state=open]:hover:bg-accent data-[state=open]:text-accent-foreground data-[state=open]:focus:bg-accent data-[state=open]:bg-accent/50 focus-visible:ring-ring/50 outline-none transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1");
